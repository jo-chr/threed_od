...
parser.add_argument('--dataset', default='standard', help='Dataset name. sunrgbd or scannet. [default: sunrgbd]')
...
parser.add_argument('--max_epoch', type=int, default=40, help='Epoch to run [default: 180]')
...
if FLAGS.dataset == 'standard':
    sys.path.append(os.path.join(ROOT_DIR, 'data'))
    from detection_dataset import DetectionVotesDataset, MAX_NUM_OBJ
    from model_util import DatasetConfig
    DATASET_CONFIG = DatasetConfig()
    TRAIN_DATASET = DetectionVotesDataset('train', num_points=NUM_POINT,
        augment=True,
